...
interface NewReportForPackageDialogProps {
  packageId: number
  packageCode: string
}

export function NewReportForPackageDialog({ packageId, packageCode }: NewReportForPackageDialogProps) {
