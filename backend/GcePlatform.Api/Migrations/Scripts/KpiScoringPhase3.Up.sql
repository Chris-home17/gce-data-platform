-- ============================================================
-- Migration: KpiScoringPhase3 — Up
-- Surfaces KpiWeight + MaxScore on App.vSubmissionTokenAssignments so
-- the submitter capture form can show "Worth N points" per KPI before
-- the value is picked. No table changes — KpiWeight already lives on
-- KPI.Assignment from Phase 1.
-- ============================================================
